...
import javax.swing.*;
import Operaciones.MostrarDatos;
...
public class Mostrar extends javax.swing.JFrame {
    ...
    public void vaciar(){
        DefaultTableModel v = (DefaultTableModel) jTable1.getModel();
        int a = jTable1.getRowCount()-1, i;
            for (i = a; i >= 0; i--) {
            v.removeRow(v.getRowCount()-1);
        }
    }
    ...
    public void mostrar(){
        vaciar();
        obj.obtener();
        jTable1.setModel(obj.getModelo());
    }
